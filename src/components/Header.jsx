            ...
            <div>
                <ul className='flex space-x-10'>
                    ...
                    <li className={`cursor-pointer py-3 text-sm font-semibold   
                     ${ pathMathRoute("/") &&  "text-black  border-b-red-400 border-b-4    " }` } 
                     onClick={()=>navigate("/")}>Home</li>

<li className={`cursor-pointer py-3 text-sm font-semibold 
  ${ pathMathRoute("/offers") && "text-bl border-b-red-400  border-b-4  " }`} onClick={()=>navigate("/offers")}>Offers</li>

<li className={`cursor-pointer py-3 text-sm font-semibold 
     ${ pathMathRoute("/sign-in") &&  "text-black border-b-red-400 border-b-4   " }`}
